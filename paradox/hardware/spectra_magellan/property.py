...
property_map = {
        "ac_failure_trouble": dict(level=EventLevel.CRITICAL, tags=['trouble'], 
            message={"True":"AC Power failure",
                     "False": "AC Power restored"}),
        "ac_loss_trouble": dict(level=EventLevel.CRITICAL, tags=['trouble'], 
            message={"True": "{Type} {label} AC Power lost",
                     "False": "{Type} {label} AC Power is OK"}),
        "alarm": dict(level=EventLevel.CRITICAL, 
            message={"True": "{Type} {label} in alarm",
                     "False": "{Type} {label} not in alarm"}),
        "alarms_in_memory": dict(level=EventLevel.INFO, 
        ...
        "arm_force": dict(level=EventLevel.INFO, 
            message={"True": "{Type} {label} forced arm",
                     "False": "{Type} {label} arm not forced"}),
        "arm_sleep": dict(level=EventLevel.INFO, 
        ...
        "arm_with_remote": dict(level=EventLevel.INFO, 
        ...
        "auxiliary_output_overload_trouble": dict(level=EventLevel.CRITICAL, tags=['trouble'], 
            message={"True":"Auxiliary output overloaded",
                     "False": "Auxiliary output load is adequate"}),
        'battery': dict(level=EventLevel.DEBUG, tags=['voltage'], 
            message="Battery voltage is {value}V"),
        "battery_failure_trouble": dict(level=EventLevel.CRITICAL, 
            message={"True": "{Type} {label} battery is low",
                     "False": "{Type} {label} battery is OK"}),
        "bell_activated": dict(level=EventLevel.CRITICAL, 
            message={"True": "{Type} {label} bell is active",
                     "False": "{Type} {label} bell is inactive"}),
        "bell_delay_finished": dict(level=EventLevel.CRITICAL, 
            message={"True": "{Type} {label} bell delay is inactive",
                     "False": "{Type} {label} bell delay is active"}),
        "bell_output_disconnected_trouble": dict(level=EventLevel.CRITICAL, tags=['trouble'], 
            message={"True":"Bell output disconnected",
                     "False": "Bell output connected"}),
        "bell_output_overload_trouble": dict(level=EventLevel.CRITICAL, tags=['trouble'], 
            message={"True":"Bell output overloaded",
                     "False": "Bell output load is adequate"}),
        "bell_trouble": dict(level=EventLevel.CRITICAL, tags=['trouble'], 
        ...
        "central_1_reporting_ftc_indicator_trouble": dict(level=EventLevel.CRITICAL, tags=['trouble'], 
            message={"True":"Central 1 reporting trouble",
                     "False": "Central 1 reporting OK"}),
        "central_2_reporting_ftc_indicator_trouble": dict(level=EventLevel.CRITICAL, tags=['trouble'], 
            message={"True":"Central 2 reporting trouble",
                     "False": "Central 2 reporting OK"}),
        "communication_trouble": dict(level=EventLevel.CRITICAL, tags=['trouble'], 
            message={"True":"Communication trouble",
                     "False": "Communication restored"}),
        "computer_fail_to_communicate_trouble": dict(level=EventLevel.CRITICAL, tags=['trouble'], 
            message={"True":"PC communication failed",
                     "False": "PC communication OK"}),
        'dc': dict(level=EventLevel.DEBUG, tags=['voltage'], 
        ...
        "keypad_battery_failure_trouble": dict(level=EventLevel.CRITICAL,
            message={"True": "Keypad {l} battery is low",
                     "False": "Keypad {label} battery is OK"}),
        "low_battery_trouble": dict(level=EventLevel.CRITICAL, tags=['trouble'], 
            message={"True":"{Type} {label} Battery is low",
                     "False": "{Type} {label} Battery level is adequate"}),
        "module_supervision_trouble": dict(level=EventLevel.CRITICAL, tags=['trouble'], 
        ...
        "rf_interference_trouble": dict(level=EventLevel.CRITICAL, tags=['trouble'], 
            message={"True":"RF Interference trouble",
                     "False": "RF Interference cleared"}),
        "rf_low_battery_trouble": dict(level=EventLevel.CRITICAL, tags=['trouble'], 
            message={"True":"{Type} {label} RF battery low",
                     "False": "{Type} {label} RF battery OK"}),
        'rf_noise_floor': dict(level=EventLevel.DEBUG, tags=['RF'], 
            message="RF Noise floor is {value}"),
        "rf_supervision_trouble": dict(level=EventLevel.CRITICAL, 
        ...
        "signal_strength": dict(level=EventLevel.DEBUG, 
        ...
        "strobe_alarm": dict(level=EventLevel.CRITICAL, 
            message={"True": "{Type} {label} Alarm Strobe is active",
                     "False": "{Type} {label} Alarm Strobe is inactive"}),
        "supervision_failure_trouble": dict(level=EventLevel.CRITICAL,
        ...
        "telephone_line": dict(level=EventLevel.CRITICAL, tags=['trouble'], 
            message={"True":"Telephone line trouble",
                     "False": "Telephone line OK"}),
        'timer_loss_trouble': dict(level=EventLevel.CRITICAL, tags=['trouble'], 
        ...
        'vdc': dict(level=EventLevel.DEBUG, tags=['voltage'], 
            message="VDC voltage is {value}V"),
        "voice_fail_to_communicate_trouble": dict(level=EventLevel.CRITICAL, tags=['trouble'], 
        ...
        "wireless_keypad_ac_trouble": dict(level=EventLevel.CRITICAL, tags=['trouble'], 
            message={"True": "Wireless Keypad AC power with trouble",
                     "False": "Wireless Keypad AC power OK"}),
        "wireless_keypad_battery_trouble": dict(level=EventLevel.CRITICAL, tags=['trouble'], 
            message={"True": "Wireless Keypad battery with trouble",
                     "False": "Wireless Keypad battery OK"}),
        "wireless_repeater_ac_loss_trouble": dict(level=EventLevel.CRITICAL, tags=['trouble'], 
            message={"True":"Wireless Repeater with AC power failure",
                     "False": "Wireless Repeater AC power is OK"}),
        "wireless_repeater_battery_trouble": dict(level=EventLevel.CRITICAL, tags=['trouble'], 
