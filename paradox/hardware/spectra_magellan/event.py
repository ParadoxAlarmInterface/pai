...
event_map = {0: dict(level=EventLevel.DEBUG, change=dict(open=False), type='zone', message='Zone {label} OK'),
             ...
             2: dict(level=EventLevel.CRITICAL, type='partition',
                     sub={0: dict(message='N/A'),
                          ...
                          11: dict(level=EventLevel.INFO, change=dict(arm=False, arm_sleep=False, arm_stay=False, alarm=False), tags=["disarm"], message='Partition {label} disarmed'),
                          12: dict(level=EventLevel.INFO, change=dict(arm=True), tags=["arm"], message='Partition {label} armed'),
                          13: dict(level=EventLevel.DEBUG, change=dict(entry_delay=True), message='Partition {label} entry delay started'),
                          14: dict(level=EventLevel.DEBUG, change=dict(exit_delay=True), message='Partition {label} exit delay started'),
             ...
             6: dict(level=EventLevel.DEBUG, message='Non-reportable event',
                     sub={0: dict(level=EventLevel.CRITICAL, type='system', tags=['trouble'], message='Telephone line trouble'),
                          ...
                          28: dict(level=EventLevel.WARN, type='system', tags=['trouble', 'supervision'], message='Supervision alert'),
                          29: dict(level=EventLevel.INFO, type='system', tags=['trouble', 'restore', 'supervision'], message='Supervision alert restore'),
             ...
             34: dict(level=EventLevel.WARN, type='special',
             ...
             42: dict(level=EventLevel.WARN, change=dict(zone_tamper_trouble=True), tags=['tamper'], type='zone', message='Zone {label} tampered'),
             ...
             45: dict(level=EventLevel.INFO, type='system', tags=['trouble', 'restore'],
             ...
             47: dict(level=EventLevel.INFO, type='system', tags=['trouble', 'restore'],
             ...
             50: dict(level=EventLevel.INFO, changes=dict(zone_rf_low_battery_trouble=False),
             ...
             52: dict(level=EventLevel.INFO, changes=dict(zone_supervision_trouble=False),
             ...
             54: dict(level=EventLevel.INFO,  change=dict(module_supervision_trouble=False), type='module', tags=['trouble', 'supervision', 'restore'],
             ...
             56: dict(level=EventLevel.INFO,  change=dict(module_tamper_trouble=False), type='module', tags=['trouble', 'tamper', 'restore'],
