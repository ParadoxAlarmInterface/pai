...
event_map = {0: dict(level=EventLevel.DEBUG, change=dict(open=False), type='zone', message='Zone {label} OK'),
             ...
             2: dict(level=EventLevel.CRITICAL, type='partition', message='Partition status',
                     sub={0: dict(message='N/A'),
                          1: dict(message='N/A'),
                          2: dict(change=dict(silent_alarm=True, alarm=True), tags=['silent_alarm'], message='Silent alarm'),
                          3: dict(change=dict(audible_alarm=True, alarm=True), tags=['buzzer_alarm'], message='Buzzer alarm'),
                          4: dict(change=dict(audible_alarm=True, alarm=True), tags=['steady_alarm'], message='Steady alarm'),
                          5: dict(change=dict(audible_alarm=True, alarm=True), tags=['pulse_alarm'], message='Pulse alarm'),
                          6: dict(change=dict(strobe_alarm=True, alarm=True), tags=['strobe'], message='Strobe'),
                          ...
                          11: dict(change=dict(arm=False, arm_full=False, arm_sleep=False, arm_stay=False, alarm=False), message='Disarm partition {label}'),
             ...
             6: dict(level=EventLevel.DEBUG, message='Non-reportable event',
                     sub={0: dict(level=EventLevel.CRITICAL, type='system', tags=['trouble'], message='Telephone line trouble'),
                          ...
                          2: dict(message='N/A'),
                          3: dict(change=dict(stay_arm=True, arm=True), type='partition', message='Arm in stay mode'),
                          4: dict(change=dict(sleep_arm=True, arm=True),type='partition', message='Arm in sleep mode'),
                          5: dict(change=dict(force_arm=True, arm=True),type='partition', message='Arm in force mode'),
                          6: dict(change=dict(stay_arm=True, arm=True),type='partition', message='Full arm when armed in stay mode'),
