...
event_map = {0: dict(level=EventLevel.DEBUG, change=dict(open=False), type='zone', message='Zone {label} OK'),
             ...
             2: dict(level=EventLevel.CRITICAL, type='partition', message='Partition {label}',
                     sub={0: dict(message='N/A'),
                          ...
                          11: dict(change=dict(arm=False, arm_sleep=False, arm_stay=False, alarm=False), message='Partition {label} disarmed'),
                          12: dict(change=dict(arm=True), message='Partition {label} armed'),
             ...
             6: dict(level=EventLevel.DEBUG, message='Non-reportable event',
                     sub={0: dict(level=EventLevel.CRITICAL, type='system', tags=['trouble'], message='Telephone line trouble'),
                          ...
                          2: dict(message='N/A'),
                          3: dict(change=dict(arm_stay=True, arm=True), type='partition', tags=['arm'], message='Arm in stay mode'),
                          4: dict(change=dict(arm_sleep=True, arm=True),type='partition', tags=['arm'], message='Arm in sleep mode'),
                          5: dict(change=dict(arm_force=True, arm=True),type='partition', tags=['arm'], message='Arm in force mode'),
                          6: dict(change=dict(arm_stay=True, arm=True),type='partition', tags=['arm'], message='Full arm when armed in stay mode'),
             ...
             29: dict(level=EventLevel.INFO, type='user', tags=['arm'], message='Arming with user {label}'),
             ...
             31: dict(level=EventLevel.INFO, type='user', tags=['disarm'], message='Disarming with user {label}'),
             32: dict(level=EventLevel.INFO, type='user', tags=['disarm', 'after_alarm'], message='Disarming after alarm with user {label}'),
             33: dict(level=EventLevel.INFO, type='user', tags=['alarm', 'cancel'], message='Alarm cancelled with user {label}'),
             ...
             40: dict(level=EventLevel.CRITICAL, type='special', tags=['alarm', 'trigger'],
