...
event_map = {0: dict(level=EventLevel.DEBUG, change=dict(open=False), type='zone', message='Zone {label} OK'),
             ...
             2: dict(level=EventLevel.CRITICAL, type='partition', message='Partition {label}',
                     sub={0: dict(message='N/A'),
                          ...
                          11: dict(change=dict(arm=False, sleep_arm=False, stay_arm=False, alarm=False), message='Disarmed'),
             ...
             6: dict(level=EventLevel.DEBUG, message='Non-reportable event',
                     sub={0: dict(level=EventLevel.CRITICAL, type='system', tags=['trouble'], message='Telephone line trouble'),
                          ...
                          2: dict(message='N/A'),
                          3: dict(change=dict(stay_arm=True, arm=True), type='partition', message='Armed in stay mode'),
                          4: dict(change=dict(sleep_arm=True, arm=True),type='partition', message='Armed in sleep mode'),
                          5: dict(change=dict(force_arm=True, arm=True),type='partition', message='Armed in force mode'),
                          6: dict(change=dict(stay_arm=True, arm=True),type='partition', message='Full arm when armed in stay mode'),
                          7: dict(level=EventLevel.CRITICAL, tags=['trouble'], change=dict(computer_fail_to_communicate_trouble=True), type='system', message='PC failed to communicate'),
