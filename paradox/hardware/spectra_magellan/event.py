...
event_map = {0: dict(level=EventLevel.DEBUG, change=dict(open=False), type='zone', message='Zone {label} OK'),
             ...
             6: dict(level=EventLevel.DEBUG, message='Non-reportable event',
                     sub={0: dict(level=EventLevel.CRITICAL, type='system', tags=['trouble'], message='Telephone line trouble'),
                          ...
                          2: dict(message='N/A'),
                          3: dict(change=dict(stay_arm=True), type='partition', message='Arm in stay mode'),
                          4: dict(change=dict(sleep_arm=True),type='partition', message='Arm in sleep mode'),
                          5: dict(change=dict(force_arm=True),type='partition', message='Arm in force mode'),
                          6: dict(change=dict(arm=True),type='partition', message='Full arm when armed in stay mode'),
             ...
             37: dict(level=EventLevel.CRITICAL, change=dict(pulse_fire_alarm=True), type='zone', tags=['fire', 'alarm'], message='Fire alarm {label}'),
             38: dict(level=EventLevel.CRITICAL, change=dict(alarm=False), type='zone', tags=['alarm_restore'], message='Zone {label} alarm restore'),
             39: dict(level=EventLevel.CRITICAL, change=dict(pulse_fire_alarm=False), type='zone', tags=['alarm_restore', 'fire'], message='Fire alarm {label} restore'),
             ...
             53: dict(level=EventLevel.WARN, type='module', tags=['trouble', 'supervision'],
                      message='Wireless module {label} supervision trouble', sub=event_opt1),
             54: dict(level=EventLevel.WARN, type='module', tags=['trouble', 'restore', 'supervision'],
                      message='Wireless module {label} supervision restore', sub=event_opt1),
             55: dict(level=EventLevel.WARN, type='module', tags=['trouble', 'tamper'],
                      message='Wireless module {label} tamper trouble', sub=event_opt1),
             56: dict(level=EventLevel.WARN, type='module', tags=['trouble', 'restore', 'supervision'],
