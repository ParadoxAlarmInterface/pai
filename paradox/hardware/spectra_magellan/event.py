...
event_map = {0: dict(level=EventLevel.DEBUG, change=dict(open=False), type='zone', message='Zone {label} OK'),
             ...
             2: dict(level=EventLevel.CRITICAL, type='partition', message='Partition status',
                     sub={0: dict(message='N/A'),
                          ...
                          11: dict(change=dict(arm=False), message='Disarm partition {label}'),
             ...
             35: dict(level=EventLevel.INFO, type='zone', message='Zone {label} bypassed'),
             36: dict(level=EventLevel.INFO, type='zone', tags=['alarm'], message='Zone {label} in alarm'),
             37: dict(level=EventLevel.INFO, type='zone', tags=['fire', 'alarm'], message='Fire alarm {label}'),
             38: dict(level=EventLevel.INFO, type='zone', tags=['alarm_restore'], message='Zone {label} alarm restore'),
             39: dict(level=EventLevel.INFO, type='zone', tags=['alarm_restore', 'fire'], message='Fire alarm {label} restore'),
             ...
             41: dict(level=EventLevel.INFO, type='zone', message='Zone {label} shutdown'),
             42: dict(level=EventLevel.INFO, type='zone', message='Zone {label} tampered'),
             43: dict(level=EventLevel.INFO, type='zone', message='Zone {label} tamper restore'),
