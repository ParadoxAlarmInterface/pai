...
event_map = {0: dict(level=EventLevel.DEBUG, change=dict(open=False), type='zone', message='Zone {} OK'),
             1: dict(level=EventLevel.DEBUG, change=dict(open=True), type='zone', message='Zone {} open'),
             2: dict(level=EventLevel.CRITICAL, type='partition', message='Partition status',
                     sub={0: dict(message='N/A'),
                          1: dict(message='N/A'),
                          2: dict(change=dict(silent_alarm=True, alarm=True), message='Silent alarm'),
                          3: dict(change=dict(audible_alarm=True, alarm=True), message='Buzzer alarm'),
                          4: dict(change=dict(audible_alarm=True, alarm=True), message='Steady alarm'),
                          5: dict(change=dict(audible_alarm=True, alarm=True), message='Pulse alarm'),
                          6: dict(change=dict(strobe_alarm=True, alarm=True), message='Strobe'),
                          7: dict(change=dict(alarm=False), message='Alarm stopped'),
                          8: dict(change=dict(squack=True), id=1, message='Squawk ON'),
                          9: dict(change=dict(squack=False), id=1, message='Squawk OFF'),
                          10: dict(message='Ground Start'),
                          11: dict(change=dict(arm=False), message='Disarm partition'),
             ...
             3: dict(level=EventLevel.DEBUG, type='system',
                     sub={0: dict(message='Bell OFF'),
                          1: dict(message='Bell ON'),
             ...
             6: dict(level=EventLevel.DEBUG, message='Non-reportable event',
                     sub={0: dict(level=EventLevel.CRITICAL, type='system', tags=['trouble'], message='Telephone line trouble'),
                          ...
                          2: dict(message='N/A'),
                          3: dict(type='partition', message='Arm in stay mode'),
                          4: dict(type='partition', message='Arm in sleep mode'),
                          5: dict(type='partition', message='Arm in force mode'),
                          6: dict(type='partition', message='Full arm when armed in stay mode'),
                          7: dict(level=EventLevel.CRITICAL, tags=['trouble'], type='system', message='PC fail to communicate'),
                          ...
                          18: dict(message='N/A'),
                          19: dict(message='N/A'),
                          20: dict(type='partition', message='Full arm when armed in sleep mode'),
                          21: dict(type='firmware', message='Firmware upgrade'),
                          22: dict(message='N/A'),
                          23: dict(type='partition', message='StayD mode activated'),
                          24: dict(type='partition', message='StayD mode deactivated'),
             ...
             # 7: 'PGM Activation',
             8: dict(level=EventLevel.DEBUG, type='remote', message='Button B pressed on remote {}'),
             9: dict(level=EventLevel.DEBUG, type='remote', message='Button C pressed on remote {}'),
             10: dict(level=EventLevel.DEBUG, type='remote', message='Button D pressed on remote {}'),
             11: dict(level=EventLevel.DEBUG, type='remote', message='Button E pressed on remote {}'),
             12: dict(level=EventLevel.DEBUG, type='remote', message='Cold start wireless zone {}'),
             13: dict(level=EventLevel.DEBUG, type='remote', message='Cold start wireless module {}'),
             14: dict(level=EventLevel.DEBUG, type='zone', change=dict(bypass='TOGGLE'), message='Bypass programming on zone {}'),
             15: dict(level=EventLevel.DEBUG, type='partition', message='User code activated output {}'),
             16: dict(level=EventLevel.DEBUG, type='zone', message='Wireless smoke maintenance signal'),
             17: dict(level=EventLevel.DEBUG, type='zone', message='Delay zone {} alarm transmission'),
             18: dict(level=EventLevel.WARN, type='zone', message='Zone {} signal strength weak 1'),
             19: dict(level=EventLevel.WARN, type='zone', message='Zone {} signal strength weak 2'),
             20: dict(level=EventLevel.WARN, type='zone', message='Zone {} signal strength weak 3'),
             21: dict(level=EventLevel.WARN, type='zone', message='Zone {} signal strength weak 4'),
             22: dict(level=EventLevel.DEBUG, type='remote', message='Button 5 pressed on remote {}'),
             23: dict(level=EventLevel.DEBUG, type='remote', message='Button 6 pressed on remote {}'),
             ...
             28: dict(level=EventLevel.INFO, type='zone', message='StayD pass acknowledged for {}'),
             29: dict(level=EventLevel.INFO, type='user', message='Arming with user {}'),
             ...
             31: dict(level=EventLevel.INFO, type='user', message='Disarming with user {}'),
             32: dict(level=EventLevel.INFO, type='user', message='Disarming after alarm with user {}'),
             33: dict(level=EventLevel.INFO, type='user', message='Alarm cancelled with user {}'),
             34: dict(level=EventLevel.INFO, type='special',
                      sub={0: dict(message='Auto-arm cancelled (on time/no movement)'),
                           1: dict(message='Disarming through WinLoad'),
                           2: dict(message='Disarming through WinLoad after alarm'),
                           3: dict(message='Alarm cancelled through WinLoad'),
                           4: dict(message='Paramedical alarm cancelled'),
                           5: dict(message='Disarm with keyswitch'),
                           6: dict(message='Disarm with keyswitch after an alarm'),
                           7: dict(message='Alarm cancelled with keyswitch'),
                           99: dict(message='Any special disarming')}
                      ),
             35: dict(level=EventLevel.INFO, type='zone', message='Zone {} bypassed'),
             36: dict(level=EventLevel.INFO, type='zone', tags=['alarm'], message='Zone {} in alarm'),
             37: dict(level=EventLevel.INFO, type='zone', tags=['fire', 'alarm'], message='Fire alarm {}'),
             38: dict(level=EventLevel.INFO, type='zone', tags=['alarm_restore'], message='Zone {} alarm restore'),
             39: dict(level=EventLevel.INFO, type='zone', tags=['alarm_restore', 'fire'], message='Fire alarm {} restore'),
             40: dict(level=EventLevel.INFO, type='special', tags=['alarm'],
             ...
             41: dict(level=EventLevel.INFO, type='zone', message='Zone {} shutdown'),
             42: dict(level=EventLevel.INFO, type='zone', message='Zone {} tampered'),
             43: dict(level=EventLevel.INFO, type='zone', message='Zone {} tamper restore'),
             44: dict(level=EventLevel.INFO, type='system', tags=['trouble'],
                      sub={0: dict(message='N/A'),
             ...
             46: dict(level=EventLevel.INFO, type='module', tags=['trouble'],
             ...
             49: dict(level=EventLevel.DEBUG, changes=dict(zone_rf_low_battery_trouble=True),
                      type='zone', tags=['trouble'], message='Low battery on zone {}'),
             50: dict(level=EventLevel.DEBUG, changes=dict(zone_rf_low_battery_trouble=False),
                      type='zone', tags=['trouble', 'restore'], message='Low battery on zone {} restore'),
             51: dict(level=EventLevel.DEBUG, changes=dict(zone_supervision_trouble=True),
                      type='zone', tags=['trouble', 'supervision'], message='Zone {} supervision trouble'),
             52: dict(level=EventLevel.DEBUG, changes=dict(zone_supervision_trouble=False),
                      type='zone', tags=['trouble', 'restore', 'supervision'], message='Zone {} supervision restore'),
             53: dict(level=EventLevel.DEBUG, type='module', tags=['trouble', 'supervision'],
                      message='Wireless module {} supervision trouble', sub=event_opt1),
             54: dict(level=EventLevel.DEBUG, type='module', tags=['trouble', 'restore', 'supervision'],
                      message='Wireless module {} supervision restore', sub=event_opt1),
             55: dict(level=EventLevel.DEBUG, type='module', tags=['trouble', 'tamper'],
                      message='Wireless module {} tamper trouble', sub=event_opt1),
             56: dict(level=EventLevel.DEBUG, type='module', tags=['trouble', 'restore', 'supervision'],
                      message='Wireless module {} tamper restore'),
             57: dict(level=EventLevel.DEBUG, type='user', tags=['medic', 'alarm'],
                      message='Non-medical alarm (paramedic) by {}'),
             58: dict(level=EventLevel.DEBUG, type='zone', message='Zone {} forced'),
             59: dict(level=EventLevel.DEBUG, type='zone', message='Zone {} included'),
