...
event_map = {
    ...
    13: dict(level=EventLevel.INFO, change=dict(arm=False, current_state="disarmed", audible_alarm=False), type='partition', message='{label} disarmed with master'),
    14: dict(level=EventLevel.INFO, change=dict(arm=False, current_state="disarmed", audible_alarm=False), type='partition', message='{label} disarmed with user code'),
    15: dict(level=EventLevel.INFO, change=dict(arm=False, current_state="disarmed", audible_alarm=False), type='partition', message='{label} disarmed with keyswitch'),
    16: dict(level=EventLevel.INFO, change=dict(arm=False, current_state="disarmed", audible_alarm=False), type='partition', message='{label} disarmed after alarm with master'),
    17: dict(level=EventLevel.INFO, change=dict(arm=False, current_state="disarmed", audible_alarm=False), type='partition', message='{label} disarmed after alarm with user code'),
    18: dict(level=EventLevel.INFO, change=dict(arm=False, current_state="disarmed", audible_alarm=False), type='partition', message='{label} disarmed after alarm with keyswitch'),
    19: dict(level=EventLevel.INFO, type='user', message='Alarm cancelled by {label} (master)'),
    20: dict(level=EventLevel.INFO, type='user', message='Alarm cancelled by {label} (user code)'),
    ...
    24: dict(level=EventLevel.CRITICAL, type='zone', change=dict(generated_alarm=True, presently_in_alarm=True), tags=['alarm'], message='Zone {label} in alarm'),
    25: dict(level=EventLevel.CRITICAL, type='zone', change=dict(fire_alarm=True), tags=['alarm', 'fire'], message='Fire alarm {label}'),
    26: dict(level=EventLevel.CRITICAL, type='zone', change=dict(presently_in_alarm=False), tags=['alarm'], message='Zone {label} alarm restore'),
