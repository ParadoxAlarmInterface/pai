...
event_map = {
    ...
    16: dict(level=EventLevel.INFO, tags=['disarm'], change=dict(arm=False, current_state="disarmed", audible_alarm=False), type='partition', message='{label} disarmed after alarm with master'),
    17: dict(level=EventLevel.INFO, tags=['disarm'], change=dict(arm=False, current_state="disarmed", audible_alarm=False), type='partition', message='{label} disarmed after alarm with user code'),
    18: dict(level=EventLevel.INFO, tags=['disarm'], change=dict(arm=False, current_state="disarmed", audible_alarm=False), type='partition', message='{label} disarmed after alarm with keyswitch'),
