...
event_map = {
    ...
    9: dict(level=EventLevel.INFO, tags=['arm'], change=dict(arm=True), type='partition', message='{label} arming with master'),
    10: dict(level=EventLevel.INFO, tags=['arm'], change=dict(arm=True), type='partition', message='{label} arming with user code'),
    11: dict(level=EventLevel.INFO, tags=['arm'], change=dict(arm=True), type='partition', message='{label} arming with keyswitch'),
    12: dict(level=EventLevel.INFO, tags=['arm'], change=dict(arm=True), type='partition', message='Special arming', sub={  # no label passed
        0: dict(type='partition', message='{label} auto arming'),
        1: dict(type='partition', message='{label} arming with Winload by {@user}', user=_minor2_provider),
        2: dict(type='partition', message='{label} late to close'),
        3: dict(type='partition', message='{label} no movement arming'),
        4: dict(type='partition', message='{label} partial arming'),
        5: dict(type='partition', message='{label} one-touch arming'),
        6: dict(type='partition', message='Future use 1'),
        7: dict(type='partition', message='Future use 2'),
        8: dict(type='partition', message='{label} (InTouch) voice module arming'),
    ...
    25: dict(level=EventLevel.CRITICAL, tags=['alarm', 'fire', 'trigger'], type='zone', change=dict(fire_alarm=True), message='Fire alarm {label}', hook_fn=_request_status_refresh),
