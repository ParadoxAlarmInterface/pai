...
def _zone_generated_alarm(event, storage, *_, **__):
    ...
    storage.update_container_object(
        "partition",
        event.partition,
        {
...
event_map = {
    ...
    3: dict(
        ...
        tags=["trouble"],
        type="zone",
        change=dict(fire_loop_trouble=True),
    ...
    4: dict(
        ...
        sub={
            ...
            4: dict(
                ...
                tags=["arm"],
                type="partition",
                change=dict(arm_away=True, arm=True),
            ...
            7: dict(
                type="system",
                message="Remote control access by {@user}",
            ...
            19: dict(
                type="system",
                message="Fail to communicate restore",
                telephone=_minor2_provider,
            ),
            20: dict(
                type="system", message="Software access (VDMP3, Ip100, Neware, WinLoad)"
            ),  # minor2 has sub events
    ...
    12: dict(
        ...
        change=dict(arm=True),
        type="partition",
        message="Special arming {label}",
        sub={  # no label passed
            0: dict(type="partition", message="auto arming"),
            1: dict(
                type="partition",
                message="arming with Winload by {@user}",
                user=_minor2_provider,
            ),
    ...
    15: dict(
        ...
        change=dict(arm=False, current_state="disarmed", audible_alarm=False),
        type="partition",
        message="{label} disarmed with keyswitch",
    ),
    16: dict(
        level=EventLevel.INFO,
    ...
    19: dict(
        ...
        tags=["alarm", "cancel"],
        type="user",
        message="Alarm cancelled by {label} (master)",
    ),
    20: dict(
        level=EventLevel.INFO,
        tags=["alarm", "cancel"],
        type="user",
        message="Alarm cancelled by {label} (user code)",
    ),
    21: dict(
        level=EventLevel.INFO,
        tags=["alarm", "cancel"],
    ...
    22: dict(
        ...
        type="partition",
        message="{label} special disarming",
        sub={  # no label passed
            0: dict(type="partition", message="Auto arm cancelled"),
            1: dict(type="partition", message="One-touch stay/instant disarm"),
            2: dict(
                type="partition",
                message="Disarming with Winload by {@user}",
                user=_minor2_provider,
            ),
            3: dict(
                type="partition",
                tags=["after_alarm"],
                message="Disarming with Winload after alarm by {@user}",
                user=_minor2_provider,
            ),
            4: dict(
                type="partition",
                message="Winload cancelled alarm by {@user}",
                user=_minor2_provider,
            ),
    ...
    24: dict(
        ...
        tags=["alarm", "trigger"],
        type="zone",
        change=dict(generated_alarm=True, presently_in_alarm=True),
    ...
    26: dict(
        ...
        tags=["alarm", "restore"],
        type="zone",
        change=dict(presently_in_alarm=False),
    ...
    31: dict(
        ...
        type="user",
        tags=["alarm", "trigger"],
        message="Duress alarm by user {label}",
        hook_fn=_request_status_refresh,
    ),
    32: dict(
        level=EventLevel.INFO,
    ...
    35: dict(
        ...
        tags=["tamper"],
        type="zone",
        message="Zone special {label} tamper",
        sub={0: dict(message="Keypad Lockout"), 1: dict(message="Voice lockout")},
    ),
    36: dict(
        level=EventLevel.WARN,
        type="system",
    ...
    39: dict(
        level=EventLevel.INFO,
        type="system",
        message="Module trouble restore",
        tags=["trouble", "restore"],
        sub={
    ...
    40: dict(
        level=EventLevel.WARN,
        type="system",
        message="Fail to communicate on telephone number",
        telephone=_minor2_provider,
    ),
    41: dict(
        level=EventLevel.WARN,
        type="zone",
        changes=dict(zone_low_battery_trouble=True),
        tags=["trouble"],
    ...
    43: dict(
        level=EventLevel.INFO,
        type="zone",
        changes=dict(zone_low_battery_trouble=False),
        tags=["trouble", "restore"],
    ...
    60: dict(
        level=EventLevel.INFO,
        type="system",
        message="Non-saved event",
        sub={0: "Remote control rejected", 1: "Future use"},
    ),
    61: dict(
        level=EventLevel.INFO,
        type="module",
