...
def test_partition_action():
    ...
    a = PerformPartitionAction.build({"fields": {"value": {"partitions": commands}}})
...
def test_zone_bypass_zone_5():
    ...
    a = PerformZoneAction.build(
        {
            "fields": {
                "value": {"flags": {"bypassed": True}, "operation": "set", "zones": [5]}
            }
        }
    )
...
def test_zone_bypass_zone_3():
    ...
    a = PerformZoneAction.build(
        {
            "fields": {
                "value": {"flags": {"bypassed": True}, "operation": "set", "zones": [3]}
            }
        }
    )
