...
# Lowercase echo variants — some panel firmware sends "&ok" rather than "&OK"
ECHO_ARM_OK_LOWER         = "AA001&ok"
ECHO_UTILITY_KEY_OK_LOWER = "UK001&ok"
...
EVENT_STATUS2_EXIT_DLY  = "G065N001A001"  # G065=Status 2: Exit delay, area 1
EVENT_STATUS2_ENTRY_DLY = "G065N002A001"  # G065=Status 2: Entry delay, area 1
...
ALL_FIXTURES = [
    ...
    ECHO_ARM_FAIL, ECHO_DISARM_FAIL,
    ...
    EVENT_STATUS2_EXIT_DLY, EVENT_STATUS2_ENTRY_DLY,
