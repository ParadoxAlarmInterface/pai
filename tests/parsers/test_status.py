...
evo_status = {
    ...
    'troubles': dict(system_trouble=False, dialer_trouble=False, module_trouble=False, bus_com_trouble=False,
                     ...
                     time_lost_trouble=False, ac_trouble=False, battery_failure_trouble=False, aux_limit_trouble=False,
                     bell_limit_trouble=False, bell_absent_trouble=False, rom_error_trouble=False, tlm_trouble=False,
